    ...
    return (
        <div className=" space-y-10 my-5">
            <div className=" text-center space-y-4">
                <h2 className=" text-4xl font-bold">TopicTrove top <span className=" text-purple-600">community posts</span></h2>
            ...
            <div className="w-5/6 mx-auto pb-5 space-y-10">
                <div className="  md:flex justify-between items-center p-5 space-y-3  shadow-lg duration-300 hover:ml-5 hover:shadow-2xl border ">
                    <div className=" flex gap-5 items-center">
                        ...
                        <div>
                            <p className=" text-xl hover:text-purple-600">Con no longer save outlook emails to KbDoc</p>
                            <p>updated by: robynphd 2 days ago</p>
                        </div>
                    </div>

                    <div className=" flex justify-between gap-5 lg:gap-10  items-center text-lg">
                        <p className=" flex items-center gap-3"><FaRegEye /> 324</p>
                        <p className=" flex items-center gap-3" ><TiMessages />23</p>
